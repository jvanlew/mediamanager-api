...
public class MediaHelpersTests {
    ...
    @Test
    void supportedPhotoExtensions_ShouldReturnExpectedExtensions() {
    ...
    @Test
    void supportedVideoExtensions_ShouldReturnExpectedExtensions() {
    ...
    @Test
    void fileNameFormat_ShouldMatchExpectedPattern() {
    ...
    @Test
    @SneakyThrows
    void fixExtensions_ShouldExecuteSuccessfully() {
    ...
    @Test
    void getNewFileName_ShouldReturnExpectedFileName() {
